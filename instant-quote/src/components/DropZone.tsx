  ...
  if (hero) {
    return (
      <div
        {...dnd}
        className={cn(
          'group border-border bg-card hover:border-primary/60 relative isolate flex min-h-[400px] flex-1 flex-col items-center justify-center overflow-hidden rounded-lg border px-8 py-14 text-center shadow-xl shadow-black/[0.06] transition-[border-color,box-shadow] hover:shadow-2xl',
